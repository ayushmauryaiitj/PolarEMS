...
export const ForecastView: React.FC<ForecastViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-cyan-50/70 dark:bg-[#0c1626] p-5 rounded-2xl border border-cyan-200 dark:border-cyan-500/30 space-y-3 transition-colors">
        <div className="flex items-center gap-2 text-xs font-mono font-bold text-cyan-800 dark:text-cyan-300 uppercase">
          <Sparkles className="w-4 h-4 text-cyan-600 dark:text-cyan-400" />
          <span>Next 6-Hour Horizon Operational Outlook</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {insights.map((ins, idx) => (
            <div key={idx} className="p-3 rounded-xl bg-white dark:bg-slate-950/60 border border-cyan-100 dark:border-slate-800/80 text-xs text-slate-700 dark:text-slate-300 flex items-start gap-2.5 shadow-xs">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-[#0e1524]/90 p-5 rounded-2xl border border-slate-200 dark:border-slate-800/80 shadow-sm dark:shadow-none space-y-3 transition-colors">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono text-slate-500 dark:text-slate-400">Forecast vs Actual Baseline</span>
          </div>
          <div className="h-60">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-[#0e1524]/90 p-5 rounded-2xl border border-slate-200 dark:border-slate-800/80 shadow-sm dark:shadow-none space-y-3 transition-colors">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono text-slate-500 dark:text-slate-400">100 kWp Bifacial</span>
            </div>
            <div className="h-56">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={records} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
          ...
          <div className="bg-white dark:bg-[#0e1524]/90 p-5 rounded-2xl border border-slate-200 dark:border-slate-800/80 shadow-sm dark:shadow-none space-y-3 transition-colors">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono text-slate-500 dark:text-slate-400">150 kW Arctic Model</span>
            </div>
            <div className="h-56">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={records} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
      ...
      <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 text-xs font-mono text-slate-600 dark:text-slate-400 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-colors">
        <div className="flex items-center gap-2">
